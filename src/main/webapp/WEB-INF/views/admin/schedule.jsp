...
<link rel="stylesheet" href="/studyplus/resources/js/bootstrap.min.css">
...
<script type="text/javascript" src="/studyplus/resources/js/calendar.js"></script>
<script type="text/javascript" src="/studyplus/resources/js/calendarSchedule.js"></script>
<style type="text/css">
thead {
    text-align: center;
}
