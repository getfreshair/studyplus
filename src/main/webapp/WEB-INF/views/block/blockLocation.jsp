...
<body>
	...
	<div class="col-xs-12 col-md-12">
		<div class="panel panel-default col-xs-11 col-md-11 "
			...
			지역 차단을 설정합니다. 일부 설정은 프로그램을 재시작해야 정상 적용됩니다.</div>
		</div>
		...
		<div class="col-xs-11 col-md-6"
			...
			<div class="form-group" align="left">
				...
				<div id="wrap" style="display: none; border: 1px solid; width: 500px; height: 300px; margin: 5px ; position: relative">
					<img
				...
				<form action="saveBlockLocationData.bl" method="post" id="locationFrm">
					<input type="text" id="sample3_address"
					class="d_form large form-control" placeholder="주소"
					style="display: inline-block; width: 65%" readonly> &nbsp;&nbsp; 
					<input type="button" value="위치 등록하기" class="btn btn-success"
					style="display: inline-block" onclick="inputLocationChecker()">
					<input type="hidden" name="locationInfo" id="inputLocation" value="">
				<br>
				</form>
				<script>
				var geocoder = new daum.maps.services.Geocoder();
				var locationCnt = $("#locationListTable tr").length -1;

				$("#locationMasterCheckBox").click(function(){
					
					if($("#locationMasterCheckBox").prop("checked")){
			            $(".locationChildCheckBox").prop("checked",true);
			        }else{
			            $(".locationChildCheckBox").prop("checked",false);
			        }
						 	...
						 	geocoder.addressSearch($('#sample3_address').val().substr(0,$('#sample3_address').val().lastIndexOf("(")), function(result, status) {
							    console.log()
							     ...
							     if (status === daum.maps.services.Status.OK) {
							    	...
							    	//document.getElementById("locationFrm").submit(); 
...
/* 						 	console.log($('#inputLocation').val() + "ㅇ?");
			...
			<script>
				...
				<h4 align="left" style="margin-top:50px"><span style="color:red;">*</span> 차단 지역 주소 목록</h4>
				<div align="left"class="container" style="width:100% ; overflow: auto; height:200px">
					
					<table class="table table-hover" id="locationListTable">
						<thead>
							<tr align="center">
