...
/* 	상단부 */
	...
	.topInfoArea { border-radius:15px; background:rgb(255, 225, 177); padding:20px 0px; text-align:center; 
	...
	.groupInfoArea { width:63.5%; margin-right:1%; display:flex; }
	  .groupInfoLeft { width:45%; padding:0px 20px; border-right:1px solid gray; }
		.category { background:lightgray; float:left; }
		  .groupTitleTbl { width:100%; margin: 0px 0px 15px; }
		  .groupTitleTbl h2 { font-size:27px; margin:0px 0px 10px; }
 		  .groupTitleTbl .groupIntro { height:55px; padding:0px 5px 0px 10px; font-size:14px; table-layout:fixed; word-break:break-all; }
	  ...
	  .groupInfoRight { width:55%; padding:0px 20px; }
	    .radiBtn { background:gray; float:right; cursor:pointer; color:white; border-radius:10px; }
	 	  ...
	 	  .statBox { /* width:90%; */ width:145px; height:220px; border-radius:15px; padding:3px 7px; display:table; }
  		    .statBoxContTbl { display:table-cell; vertical-align:middle; margin:0px; }
  		    .statBoxContTbl tbody { height:170px; display: inline-block; }
		    .statBoxContTbl h3 { margin:0px 0px 5px; }
  		    .statBoxContTbl tr:first-child td { /* width:140px; */ padding-bottom:12px; font-size:1.2em; border-bottom:1px dashed; }
   		    .statBoxContTbl tr:nth-child(2n) td > div { width:100%; height:91px; margin:0px auto; display:inline-table; text-align:center; }
   		    .statBoxContTbl tr:nth-child(2n) td div div { padding-top:10px; font-size:13px; display:inline-block; text-align:right;  }
   		    .statBoxContTbl tr:nth-child(2n) td div div strong { float:right;  }
			.goalRatio { font-weight:bold; font-size:16px !important; padding-top:0px !important; display:table-cell !important; vertical-align:middle; text-align:center !important; }

	.myInfoArea { width:36.5%; padding:20px 20px; }
...
/*	하단 컨텐츠 작성 */
	...
	.bottomContentArea { background:rgb(235, 235, 235, 0.4); /* opacity:0.5; */ height:100%; padding:15px 15px; display:inline-block; text-align:center; }
	

	
/*	좌측 영역 */
	.leftContent { width:26.4%; padding-right:0px; margin-right:0.3%; border-right:1px solid gray; }
	  .leftContentWrap { width:100%; height:100%; display:inline-block; }
		...
		.leftContentTabMenu span { cursor:pointer; padding:0px 5px; font-size:14px; /* font-weight:bold; */ }
		
		.leftIncludeArea { width:100%; height:95%; overflow:auto; background:yellow; }
		
		
		
	.centerContent { width:49%; margin-right:0.3%; border-right:1px solid gray; }
...
/*	공통 요소 속성 */
	...
	.radiusBoxSmall { border-radius:15px; margin-bottom:10px; padding:3px 12px; font-size:12px; font-weight:bold; display:inline; }
				...
				<div class="groupInfoArea topInfoArea">
					...
					<div class="groupInfoLeft">
						<table class="topInfoAllWrapTbl">
							...
							<tr><td>
								<table class="topInfoContWrapTbl">
									<tr><td>
