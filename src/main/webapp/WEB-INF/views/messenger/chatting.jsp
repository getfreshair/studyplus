...
<script type="text/javascript"
	src="/studyplus/resources/js/sockjs.min.js"></script>
<style>
</style>
</head>
<body>
	...
	<input type="text" id="nickname" value = "${ member1_Nickname }" style = "display:none">
 ...
 function send() {
  ...
  if(msg != ""){
	  ...
	  message.message_content = $("#message").val()
  	  message.message_sender = '${loginUser.member_Code}'
  }
