...
public class Banner {
	...
	public Banner(int pr_Code, String pr_Company, String pr_Title, String pr_Link, int pr_Order, int pr_Type,
			int pr_Contractmoney, int category_Code, String pr_StartDate, String pr_EndDate, Files files) {
		super();
	...
	public int getPr_Contractmoney() {
		return pr_Contractmoney;
	}


	public void setPr_Contractmoney(int pr_Contractmoney) {
		this.pr_Contractmoney = pr_Contractmoney;
	}
